...
def generate_renditions(source_height: int):
    ...
    for height in TARGET_HEIGHTS:
        if source_height >= height:
            renditions.append({"height": height})
...
def build_ffmpeg_command(
    ...
    cmd = [
        ...
        str(ffmpeg_path()), # means "look for an executable named ffmpeg on PATH." Use your ffmpeg_path() instead.
...
def get_default_output_path(file_name: str) -> Path:
    home = Path.home()
